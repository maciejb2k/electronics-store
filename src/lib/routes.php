...
use App\Classes\Middleware\AdminMiddleware;
use App\Classes\Middleware\UserMiddleware;

use Pecee\SimpleRouter\SimpleRouter;
use Pecee\Http\Request;


SimpleRouter::group(['prefix' => '/projekt-bazy'], function () {
  // Homepage
...
SimpleRouter::error(function (Request $request, \Exception $exception) {
  switch ($exception->getCode()) {
    case 404:
      response()->redirect('/projekt-bazy/');
  }
});
